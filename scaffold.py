...
def command(argv):
    ...
    parser.add_argument("-d", help="Removes duplication", action = "store_true", required=False)
...
if toRemoveDup:
    QUERY_FASTA_NAME = OUTPUT_FASTA_NAME
    SUBJECT_FASTA_NAME = OUTPUT_FASTA_NAME
